...
function [top_boxes cats_found cats_ids m] = detect10k_demo(rcnn_model, rcnn_feat, imname, outname)
...
% save('test.mat','top_boxes','cats_found','cats_ids')
