...
import numpy as np
import glob
#caffe_root = '../_lsda/external/caffe'
caffe_root = '../../'
import sys
...
caffe.set_device(0)
import pickle
data_path = '/nfs/bigeye/anjali/Activity/lisa-caffe-public-lstm_video_deploy/examples/LRCN_activity_recognition/'

RGB_video_path = '/nfs/bigeye/anjali/Activity/lisa-caffe-public-lstm_video_deploy/examples/LRCN_activity_recognition'
#flow_video_path = ''
if len(sys.argv) > 1:
  video = sys.argv[1]
else:
...
RGB_singleFrame = data_path + 'single_frame_all_layers_hyb_RGB_iter_5000.caffemodel'
#flow_singleFrame = data_path + 'single_frame_all_layers_hyb_flow_iter_50000.caffemodel'
RGB_lstm = data_path + 'RGB_lstm_model_iter_30000.caffemodel'
#flow_lstm = data_path + 'flow_lstm_model_iter_50000.caffemodel'
